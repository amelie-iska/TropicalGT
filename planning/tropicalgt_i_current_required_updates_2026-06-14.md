...
- Keep the served audit bundle at `127.0.0.1:8991` pointed to the latest completed real b60 periodic audit; current browser serving was reattached to step `3500` without copying generated artifacts. The step-3500 validation report records BPB/exact BPB `1.4940912929263006`, graph-BPB `20.178089761117462`, graph-conditioned BPB without side cost `1.3135784788873124`, NLL `1.0356251671910286`, and invalid graph rate `0.0`. During step-3250 and step-3500 audit generation, generated `step_00002750/got_audit` and `step_00003000/got_audit` were pruned under the active retention policy after the next audit step existed; milestone audits, step 3250, step 3500, compact validation reports, and non-audit artifacts remain.
