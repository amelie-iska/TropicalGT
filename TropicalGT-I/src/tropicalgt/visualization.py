    ...
    def _svg_chain_staircase(dim: int, items: Sequence[tuple[int, int, int, str]], *, primary: bool = False) -> str:
        ...
        for lvl in range(0, int(y_axis_max) + 1):
            for rg in range(0, int(x_axis_max) + 1):
                ...
                color = "#111827" if inside else "#f8fafc"
                opacity = "0.42" if inside else "0.98"
                dot_r = 2.35 if primary else 1.75
                dots.append(
        ...
        for m_lvl, m_rg in mins:
            ...
            rects.append(
                ...
                "fill='rgba(148,163,184,0.44)' stroke='rgba(226,232,240,0.30)' stroke-width='1'>"
