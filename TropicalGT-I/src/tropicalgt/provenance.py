...
PROVENANCE_REGISTRY: tuple[ProvenanceEntry, ...] = (
    ...
    ProvenanceEntry(
        name="chart_vector_bundle_transport_contract",
        kind="visualization_contract",
        surface="chart/vector-bundle transport sidecar and Herschel 5K report",
        optimize_directly=False,
        description="No-proxy chart-bundle transport and vector-bundle paper-sidecar telemetry contract for exported chart ids, monomial transports, matroid flat-incidence diagnostics, and completeness tiers.",
        replacement_or_guardrail="Report only recorded chart_bundle_transport_sidecar JSON with exported metadata, monomial transport and matroid contracts, vector-bundle completeness contracts, and no-proxy flags; never promote telemetry to theorem, toric embedding, tropical variety, global toric variety, or normal-fan certificates.",
        match_terms=(
            "tropicalgt.chart_bundle_transport_sidecar.v1",
            "tropicalgt.chart_bundle_transport_metadata.v1",
            "tropicalgt.vector_bundle_paper_sidecar.v1",
            "tropicalgt.vector_bundle_paper_sidecar_completeness.v1",
            "tropicalgt.herschel_chart_bundle_transport_evidence.v1",
            "chart_bundle_transport_sidecar",
            "chart/vector-bundle telemetry",
            "vector-bundle completeness contracts",
            "missing_monomial_transport_no_proxy_contract",
            "missing_bundle_matroid_no_proxy_contract",
            "missing_chart_bundle_no_proxy_contract",
            "toric embedding, tropical variety, global toric variety, or normal-fan certificate",
        ),
    ),
    ProvenanceEntry(
        name="nll_density_render_contract",
        kind="visualization_contract",
        surface="NLL density cloud sidecar and Herschel 5K report",
        optimize_directly=False,
        description="No-proxy NLL density visual-layer contract over actual model GoT anchors and legend-only Gaussian support samples.",
        replacement_or_guardrail="Report only recorded got_nll_density_cloud_payload sidecars with tropicalgt.nll_density_render.v1, visible actual model anchors, non-model support samples hidden as legend-only support, positive kernel bandwidth, NLL range, and no-proxy flags.",
        match_terms=(
            "tropicalgt.nll_density_render.v1",
            "tropicalgt.herschel_nll_density_evidence.v1",
            "got_nll_density_cloud_payload",
            "visible actual model anchors",
            "legend-only non-model support samples",
            "missing_nll_density_no_proxy_contract",
            "support_samples_hidden_as_model_states",
            "support_samples_are_model_states",
        ),
    ),
    ProvenanceEntry(
        name="graphcg_direction_render_contract",
        kind="visualization_contract",
        surface="GraphCG direction-cosine sidecar and Herschel 5K report",
        optimize_directly=False,
        description="No-proxy GraphCG direction evidence contract for all-direction cosine payloads, projection-basis certificates, and full-rank activity panels.",
        replacement_or_guardrail="Report only recorded graphcg_direction_cosines_payload sidecars with all model-derived directions rendered, exact direction ids preserved, projection-basis certificates present, and no-proxy/readability contracts; do not treat this as a semantic identifiability proof or toric fan certificate.",
        match_terms=(
            "tropicalgt.graphcg_direction_evidence.v1",
            "tropicalgt.graphcg_direction_readability.v1",
            "tropicalgt.herschel_graphcg_direction_evidence.v1",
            "graphcg_direction_cosines_payload",
            "all model-derived directions rendered",
            "projection-basis certificate",
            "missing_graphcg_no_proxy_contract",
            "safe_to_render_full_rank_direction_evidence",
        ),
    ),
    ProvenanceEntry(
    ...
    ProvenanceEntry(
        name="tropical_support_render_contract",
        kind="visualization_contract",
        surface="tropical support heatmap and Herschel 5K report",
        optimize_directly=False,
        description="No-proxy tropical support render/readability contract, model support-probability provenance, and wall-margin threshold audit evidence.",
        replacement_or_guardrail="Render and report only recorded tropical_support_payload sidecars with model_tropical_support_probabilities, observed support assignments, and wall-margin rates; do not treat threshold audits as certified normal-fan wall-crossing counts.",
        match_terms=(
            "tropicalgt.tropical_support_render.v1",
            "tropicalgt.tropical_support_readability.v1",
            "tropicalgt.herschel_tropical_support_evidence.v1",
            "tropical_support_payload",
            "model_tropical_support_probabilities",
            "wall_margin_metric_scope",
            "wall-margin rates",
            "missing_tropical_support_no_proxy_contract",
            "margin_threshold_audit_not_certified_normal_fan_wall_crossing",
        ),
    ),
    ProvenanceEntry(
    ...
    ProvenanceEntry(
        name="herschel_simplicial_complex_evidence",
        kind="evidence_report_contract",
        surface="radius-filtered simplicial complex and SimplexTree Herschel 5K report",
        optimize_directly=False,
        description="Herschel report contract for recorded full-trajectory complexes, radius slider contracts, GUDHI simplex-tree posets, and per-step reasoning complex manifests.",
        replacement_or_guardrail="Report only recorded trajectory-complex payloads, radius-slider summaries, simplex-tree poset contracts, and reasoning-step manifests with actual-data/no-proxy flags; never use a global trajectory plot, embedding map, or static probability object as a substitute for per-step filtered complexes.",
        match_terms=(
            "tropicalgt.herschel_simplicial_complex_evidence.v1",
            "tropicalgt.trajectory_complex_overlay_contract.v1",
            "tropicalgt.radius_filtration_slider_contract.v1",
            "tropicalgt.simplex_tree_poset.v1",
            "tropicalgt.reasoning_step_complex_maps.v1",
            "full_trajectory_complex_available",
            "radius_slider_available",
            "simplex_tree_poset_available",
            "reasoning_step_manifest_available",
            "simplicial_complex_evidence",
            "Simplicial Complex And Simplex-Tree Evidence",
            "simplicial-complex-statuses",
            "trajectory_complex_overlay_contract_unavailable_or_unsafe",
            "radius_slider_contract_unavailable_or_unsafe",
            "simplex_tree_poset_contract_unavailable_or_unsafe",
            "reasoning_step_complex_manifest_unavailable_or_unsafe",
        ),
    ),
    ProvenanceEntry(
        name="herschel_inference_audit_backfill_evidence",
        kind="evidence_report_contract",
        surface="Inference audit and interactive backfill evidence in Herschel 5K report",
        optimize_directly=False,
        description="Herschel report contract for recorded inference_audit payloads and interactive audit backfill reports.",
        replacement_or_guardrail="Report inference_audit as raw recorded inference evidence and backfill_report/backfill_report_latest as rendering/provenance repair logs only; backfill actions can prove rerendering from existing payloads or explicit unavailable diagnostics, never model quality, CAS certificates, tropical fans, toric embeddings, normal fans, or persistence modules.",
        match_terms=(
            "tropicalgt.herschel_inference_audit_backfill_evidence.v1",
            "inference_audit_backfill_evidence",
            "Inference Audit And Backfill Evidence",
            "inference-audit-backfill-statuses",
            "interactive-backfill-action-kinds",
            "inference_audit_available",
            "interactive_backfill_report_available",
            "inference_audit_unavailable",
            "interactive_backfill_report_unavailable",
            "inference_audit.json",
            "backfill_report.json",
            "backfill_report_latest.json",
            "tropicalgt.interactive_audit_backfill.v1",
            "got_trajectory_contract_backfill",
            "inference_audit_dashboard_rebuilt",
            "missing_inference_scaling_candidates",
            "missing_interactive_backfill_schema",
            "missing_backfill_no_fabrication_policy",
        ),
    ),
    ProvenanceEntry(
        name="herschel_trajectory_embedding_visual_evidence",
        kind="evidence_report_contract",
        surface="GoT trajectory and embedding-map visual contract in Herschel 5K report",
        optimize_directly=False,
        description="Herschel report contract for recorded GoT trajectory and embedding-map payloads backed by raw model graph_state embeddings and PCA diagnostics.",
        replacement_or_guardrail="Report only recorded got_trajectory_payloads and got_embedding_map_payloads sidecars with raw model graph_state embeddings, validator-style PCA diagnostics, parent-child GoT metadata, filtered simplicial objects, and the embedding trajectory identity contract; duplicate PCA coordinates are warnings, not geometric-separation claims.",
        match_terms=(
            "tropicalgt.herschel_trajectory_embedding_visual_evidence.v1",
            "trajectory_embedding_visual_evidence",
            "Trajectory Embedding Visual Evidence",
            "trajectory-embedding-visual-statuses",
            "trajectory_embedding_visual_available",
            "trajectory_payload_unavailable",
            "embedding_map_payload_unavailable",
            "got_trajectory_payloads.json",
            "got_embedding_map_payloads.json",
            "tropicalgt.embedding_trajectory_identity.v1",
            "model graph_state embeddings",
            "graph_of_thought_parent_edges",
            "missing_embedding_trajectory_identity_contract",
            "invalid_model_graph_state_pca_diagnostics",
            "trajectory_nll_surface_not_point_anchored",
            "missing_raw_model_embeddings",
            "filtered_object_count_mismatch",
            "parent_child_edge_count_too_small",
        ),
    ),
    ProvenanceEntry(
        name="herschel_two_parameter_bifiltration_visual_evidence",
        kind="evidence_report_contract",
        surface="Miller-Sturmfels two-parameter bifiltration visual contract in Herschel 5K report",
        optimize_directly=False,
        description="Herschel report contract for recorded two-parameter bifiltration visual payloads whose primary view is the Miller-Sturmfels bivariate staircase over F2[x_level,x_radius].",
        replacement_or_guardrail="Report only recorded tropicalgt.two_parameter_bifiltration_visual.v1 payloads with x_radius horizontal, x_level vertical, actual-data/no-proxy contracts, structure-map evidence, staircase cards, quotient-basis lattice points, Hilbert numerator terms, adjacent LCM syzygy lists, and explicit theorem-scope boundaries; never promote secondary rank surfaces or scoped staircase resolutions to full persistence-module free resolutions or CAS certificates.",
        match_terms=(
            "tropicalgt.herschel_two_parameter_bifiltration_visual_evidence.v1",
            "two_parameter_bifiltration_visual_evidence",
            "Two-Parameter Bifiltration Visual Evidence",
            "two-parameter-bifiltration-visual-statuses",
            "two_parameter_bifiltration_visual_available",
            "tropicalgt.two_parameter_bifiltration_visual.v1",
            "tropicalgt.miller_sturmfels_staircase_evidence.v1",
            "tropicalgt.two_parameter_module_staircase_contract.v1",
            "miller_sturmfels_bivariate_staircase",
            "missing_miller_sturmfels_staircase_evidence",
            "missing_two_parameter_no_proxy_contract",
            "rank_surface_still_marked_primary",
        ),
    ),
    ProvenanceEntry(
        name="herschel_topological_algebra_evidence",
        kind="evidence_report_contract",
        surface="topological algebra and persistence sidecars in Herschel 5K report",
        optimize_directly=False,
        description="Herschel report contract for recorded trajectory topological algebra, trajectory growth topology, inference topology, and inference algebra sidecars.",
        replacement_or_guardrail="Report only recorded topology/algebra sidecars; empty inference_algebra payloads and incomplete topology reports stay unavailable and cannot substitute for chain complexes, persistence intervals, multiparameter modules, CAS certificates, or restart evidence.",
        match_terms=(
            "tropicalgt.herschel_topological_algebra_evidence.v1",
            "topological_algebra_evidence",
            "Topological Algebra Evidence",
            "topological-algebra-statuses",
            "trajectory_topological_algebra_available",
            "trajectory_growth_topology_available",
            "inference_topology_available",
            "inference_algebra_empty_unavailable",
            "topological_algebra_report_unavailable_or_incomplete",
            "inference_algebra_sidecar_empty",
        ),
    ),
    ProvenanceEntry(
